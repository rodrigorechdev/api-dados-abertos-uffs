package br.com.dadosabertosuffs.constant;

public class DadosAbertosConst {
    public final static String URL_PORTAL_DADOS_ABERTOS_UFFS = "https://dados.uffs.edu.br/api/3/action/";

    public final static String PATH_RECURSO = "package_show";
